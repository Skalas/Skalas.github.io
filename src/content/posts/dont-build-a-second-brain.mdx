...
I have a few agents now. Claude Code on the laptop. A CLI orchestrator I call OpenClaw, with an agent named Nico. A Telegram agent named Hermes. They all do different work, on different machines.
